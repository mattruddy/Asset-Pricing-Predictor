                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            row = stock_df[(stock_df.index == stock_price)][ticker.upper()]
                            stock_price = round(float(row))
                        except Exception as e:
                            print("stock price  later:",str(e))
                    ...
                    pass
    print("key_stats_acc_WITH_NA.csv")
    df.to_csv("key_stats_acc_WITH_NA.csv")
